...
const ENTRIES: AnprEntry[] = [
  ...
  { id: '11', time: '14:31:58', vehicleNumber: 'TN09CV6677', camera: 'CAM_003', vehicleType: 'Truck', confidence: 90 },
  { id: '12', time: '14:31:55', vehicleNumber: 'GJ01DR8899', camera: 'CAM_004', vehicleType: 'Car', confidence: 87 },
  { id: '13', time: '14:31:52', vehicleNumber: 'WB05ES2233', camera: 'CAM_001', vehicleType: 'Bus', confidence: 88 },
  { id: '14', time: '14:31:49', vehicleNumber: 'PB10FT4455', camera: 'CAM_002', vehicleType: 'Car', confidence: 91 },
  { id: '15', time: '14:31:47', vehicleNumber: 'UP32GU6677', camera: 'CAM_003', vehicleType: 'Bike', confidence: 82 },
  { id: '16', time: '14:31:44', vehicleNumber: 'HR26HV8899', camera: 'CAM_004', vehicleType: 'Truck', confidence: 85 },
  { id: '17', time: '14:31:40', vehicleNumber: 'TS09JD1122', camera: 'CAM_001', vehicleType: 'Car', confidence: 93 },
  { id: '18', time: '14:31:37', vehicleNumber: 'KL07KG3344', camera: 'CAM_002', vehicleType: 'Bus', confidence: 86 },
  { id: '19', time: '14:31:34', vehicleNumber: 'WB18LH5566', camera: 'CAM_003', vehicleType: 'Car', confidence: 89 },
  { id: '20', time: '14:31:31', vehicleNumber: 'AP09MJ7788', camera: 'CAM_004', vehicleType: 'Bike', confidence: 84 },
  { id: '21', time: '14:31:27', vehicleNumber: 'MP04NK9900', camera: 'CAM_001', vehicleType: 'Truck', confidence: 88 },
  { id: '22', time: '14:31:24', vehicleNumber: 'DL3CPN1122', camera: 'CAM_002', vehicleType: 'Car', confidence: 90 },
  { id: '23', time: '14:31:21', vehicleNumber: 'CG04PR3344', camera: 'CAM_003', vehicleType: 'Car', confidence: 86 },
  { id: '24', time: '14:31:18', vehicleNumber: 'WB22QS5566', camera: 'CAM_004', vehicleType: 'Bus', confidence: 87 },
  { id: '25', time: '14:31:14', vehicleNumber: 'JH05RT7788', camera: 'CAM_001', vehicleType: 'Bike', confidence: 83 },
  { id: '26', time: '14:31:11', vehicleNumber: 'UK08SU9900', camera: 'CAM_002', vehicleType: 'Car', confidence: 92 },
  { id: '27', time: '14:31:08', vehicleNumber: 'WB06TV1122', camera: 'CAM_003', vehicleType: 'Truck', confidence: 85 },
  { id: '28', time: '14:31:05', vehicleNumber: 'DL5CV3344', camera: 'CAM_004', vehicleType: 'Car', confidence: 88 },
]
...
function AnprLog() {
  ...
  return (
    <div className="flex w-full min-h-0 flex-col rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-900">
      ...
      <div ref={containerRef} className="min-h-0 flex-1 overflow-x-auto overflow-y-auto">
        <table className="w-full border-collapse text-sm">
          ...
          <tbody>
            {pageItems.map((entry) => (
              <tr key={entry.id} data-sm-row className="border-b border-slate-50 last:border-0 dark:border-slate-800/60">
              ...
              {Array.from({ length: totalPages }, (_, i) => i + 1).map((p) => (
                <button
                  ...
                  className={`h-6 w-6 rounded-full text-xs transition-colors ${
                    p === safePage ? 'bg-slate-900 text-white dark:bg-slate-100 dark:text-slate-900' : 'text-slate-500 hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-800'
                  }`}
                >
                  {p}
                </button>
