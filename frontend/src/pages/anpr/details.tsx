...
export default function VehicleInformation() {
  return (
    <div className="flex min-h-0 w-full flex-1 flex-col rounded-xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
      <h3 className="mb-4 text-base font-semibold text-slate-900 dark:text-slate-100">Vehicle Information</h3>
      ...
      <dl className="space-y-3">
        ...
        <div className="flex items-center text-sm">
          <dt className="w-32 shrink-0 text-slate-500 dark:text-slate-400">Status</dt>
          <dd>
